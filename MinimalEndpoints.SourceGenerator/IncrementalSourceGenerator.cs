...
public sealed class IncrementalSourceGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        IncrementalValueProvider<GeneratorOptions> fluentValidation = context.CompilationProvider.Select(static (compilation, cancellationToken) =>
        {
        ...
        context.RegisterSourceOutput(fluentValidation, static (scp, source) =>
        {
    ...
    private static void Execute((Compilation Left, ImmutableArray<Endpoint> Right) source, SourceProductionContext spc, string implementingMethod, string hintName)
    {
        ...
        else
        {
            ...
            foreach (var group in groupedEndpoints)
            {
                ...
                sb.Append($$"""
                        var {{groupName}} = app.MapGroup("{{groupEndpoints[0].Group!.Route}}");
